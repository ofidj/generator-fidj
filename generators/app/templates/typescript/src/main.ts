    ...
    void action(async () => {
      ...
      notice =
        result.status === "pending"
          ? "Access revoked and local notes erased. Fidj storage cleanup is pending; ask the app owner to complete it."
          : "You left this app. Its membership and notes were erased. Your other apps are unchanged.";
    });
  });
}
