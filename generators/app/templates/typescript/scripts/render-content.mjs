...
export function renderContent(config) {
  ...
  <header class="topbar"><a class="brand" href="#/content">${escape(config.title)}</a><a class="fidj-brand" href="${escape(config.dashboardUrl)}/my"><img src="./fidj-logo.png" alt="Fidj">My privacy ↗</a></header>
